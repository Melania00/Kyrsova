...
namespace TestLab.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AdditionalServicesBooking",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalServicesBooking", x => new { x.AdditionalServicesId, x.BookingsId });
                    table.ForeignKey(
                        name: "FK_AdditionalServicesBooking_AdditionalServices_AdditionalServi~",
                        column: x => x.AdditionalServicesId,
                        principalTable: "AdditionalServices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdditionalServicesBooking_Bookings_BookingsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdditionalServicesBooking_BookingsId",
                table: "AdditionalServicesBooking",
                column: "BookingsId");
